...
: ${AMENT_CURRENT_PREFIX:="/home/seifelshafey/nav_robot_ws/src/install/teleop_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/teleop_robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/teleop_robot/environment/path.sh"
